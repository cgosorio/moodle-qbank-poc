# Moodle Question Bank Manager

Prototipo de aplicación Java para la gestión de la jerarquía del banco de preguntas de Moodle.
...
Prueba de concepto en desarrollo. El historial de _commits_ refleja la evolución incremental del prototipo.
